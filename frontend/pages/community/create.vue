...
<template>
  <form class="max-w-md mx-auto" @submit.prevent="createCommunity">
    <AuthHeader title="Topluluk oluştur"
                subtitle="Create a new community and start sharing your knowledge with others."/>
    <div class="container mx-auto">
      <div class="mt-8">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <!-- hidden or not -->
          <div class="sm:col-span-2">
            <label for="isPrivate" class="block text-sm font-semibold text-gray-700">Gizli mi?</label>
