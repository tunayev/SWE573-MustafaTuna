...
const {
  ...
  variant?: 'filled' | 'outlined' | 'underline' | 'simple'
  type?: string
  label?: string
  placeholder?: string
  prependIcon?: string
...
const input = tv({
  ...
  variants: {
    variant: {
      ...
      underline: {
        label: 'mb-0',
        inner: 'border-b-2 transition duration-200',
        input:
            'px-0 bg-transparent px-0 border-none focus:border-none focus:outline-none',
      },
      simple: {
        label: 'mb-0',
        inner: 'transition duration-200 border-b-2 focus-within:border-primary-600',
        input:
            'px-0 bg-transparent px-0 ring-0 outline-none border-none focus:border-none focus:outline-none focus:ring-0',
      },
      outlined: {
